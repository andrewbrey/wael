...
import { Form, Link, redirect, type ActionFunction, type LoaderFunction } from "remix";
import { notFound } from "remix-utils";
import { db } from "~/utils/db.server";
import { json, useActionData, useLoaderData } from "~/utils/io";
...
type LoaderData = Pick<LogEntry, "weight" | "cardio" | "lift" | "notes">;

export const loader: LoaderFunction = async ({ params }) => {
  const entry = await db.logEntry.findUnique({
    select: { weight: true, cardio: true, lift: true, notes: true },
    where: { id: params.logEntry },
  });
        ...
        <div className="space-y-8">
          <div>
            <div className="select-none">
              <h3 className="text-lg font-medium leading-6 text-gray-900">Edit Log Entry</h3>
              ...
              <div className="sm:col-span-2">
                ...
                <div className="mt-1 flex rounded-sm shadow-sm">
                  ...
                  <input
                    ...
                    autoComplete="off"
                    autoFocus
                    defaultValue={actionData?.fields?.weight ?? loaderData.weight}
              ...
              <div className="sm:col-span-6">
                ...
                <div className="mt-1">
                  <textarea
                    ...
                    defaultValue={actionData?.fields?.notes ?? loaderData.notes ?? ""}
                  />
                </div>
                <p className="mt-2 select-none text-sm text-gray-500">Add any notes about this log entry.</p>
              </div>
            ...
            <div className="relative flex items-start">
              <div className="flex h-5 items-center">
                <input
                  ...
                  name="cardio"
                  type="checkbox"
                  defaultChecked={loaderData.cardio}
            ...
            <div className="relative flex items-start">
              <div className="flex h-5 items-center">
                <input
                  ...
                  name="lift"
                  type="checkbox"
                  defaultChecked={loaderData.lift}
                  className="h-4 w-4 cursor-pointer rounded-sm border-gray-300 text-gray-600 focus:ring-gray-500"
                />
              </div>
              <div className="ml-3 text-sm">
