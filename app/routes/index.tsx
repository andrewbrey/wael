...
export default function IndexRoute() {
  ...
  return (
    <main className="relative flex h-full flex-col overflow-hidden">
      ...
      <div className="my-6 mx-6 max-h-[50%] flex-shrink-0 flex-grow overflow-y-auto overflow-x-hidden outline-none ring-black focus-visible:ring-4 focus-visible:ring-offset-4 md:max-h-[35%]">
